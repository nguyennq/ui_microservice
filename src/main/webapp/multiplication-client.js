    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            data.forEach(function (row) {
                $('#results-body').append(
                    '<tr><td>' + row.id +'</td>'+
                    '<td>' + row.multiplication.factorNumberA +' x ' + row.multiplication.factorNumberB + '</td>'+
        ...
        $.ajax({
            ...
            success: function(result){
                if(result.correct) {
                    ...
                    $('.result-message').empty().append("<p class='bg-danger text-center'>Ooops that's not correct! But keep trying!</p>");
                }
            }
        });
